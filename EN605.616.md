...
$$
\begin{align}
\forall \mathcal{f}_{i},\mathcal{f}_{j}\in\mathcal{F} \implies \mathcal{f}_{i}\smallcircle\mathcal{f}_{j} = \mathcal{f}_{j}\smallcircle\mathcal{f}_{i} \vee \mathcal{f}_{i}\smallcircle\mathcal{f}_{j} = \mathcal{f}_{i} \veeodot \mathcal{f}_{j}\smallcircle\mathcal{f}_{i} = \mathcal{f}_{j}
\end{align}
$$
