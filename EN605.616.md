...
$$
\begin{align}
\mathcal{F}\in Common2 \implies \forall \mathcal{f}_{i},\mathcal{f}_{j}\in\mathcal{F}: \mathcal{f}_{i}\circ\mathcal{f}_{j} = \mathcal{f}_{j}\circ\mathcal{f}_{i} \vee \mathcal{f}_{i}\circ\mathcal{f}_{j} = \mathcal{f}_{i}
\end{align}
$$
