...
Even if we switch the order of the `getAndIncrement()` calls, we will still get an invalid result. That is, we invoke $A.enq(\alpha)$ then invoke $B.enq(\beta)$. However, the first dequeue yields $\beta$. Is result is independent of the order of `getAndIncrement()`. Thus this instruction cannot be a linearization point.
...
[null,... ,null, null, null_{t},... ]     &                      & B.getAndIncrement()  & Invocation_{B}    \\
\hline
[null,... ,null, \alpha, null_{t},... ]   & A.set(\alpha)        &                      & Response_{A}      \\
\hline
[null,... ,null, \alpha, \beta_{t},... ]  &                      & B.set(\beta)         & Response_{B}      \\
\hline
[null,... ,null, null, \beta_{t},... ]    & A.dec()              &                      & Returns \alpha      \\
\hline
[null,... ,null, null, null_{t},... ]     &                      & B.deq()              & Returns \beta      \\
\end{tabular}
\$$
