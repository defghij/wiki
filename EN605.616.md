...
\begin{tabular}{|c|c|c|}
\hline
\text{Array}                           & \text{Thread A}      & \text{Thread B} \\
\hline
[null,... ,null_{t}, null, null,... ]     &                      &                   \\
\hline
[null,... ,null, null_{t}, null,... ]     & A.getAndIncrement()  &                   \\
[null,... ,null, null, null_{t},... ]     &                      & B.getAndIncrement()     \\
[null,... ,null, null, \beta,... ]     &                      & B.set(\beta)     \\
[null,... ,null, \alpha, \beta,... ]     & A.set(\alpha)        &     \\
\end{tabular}
$$
...
class AcmeRegister implements Register{
  ...
  // A tomic multi-reader single-writer registers
